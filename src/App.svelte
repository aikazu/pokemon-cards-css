<script>
	...
	import { cards as cardsStore } from "./lib/stores/cards.js";
...
<main>
	...
	{#if query.length < 3}
		<CardSection anchor="common" cards={basics} {isLoading}>
			<h2 id="⚓-common">
		...
		<CardSection anchor="holo" cards={holos} {isLoading}>
			<h2 id="⚓-holo">
			...
			<p>
				...
				<mark>clip-path</mark> to mask the holo areas for each stage. To get the holo
				effect to change while rotating the card I set the background-position of
				each gradient layer based on cursor.
			</p>
		</CardSection>

		<CardSection anchor="galaxy" cards={cosmos} {isLoading}>
			<h2 id="⚓-galaxy">
		...
		<CardSection anchor="amazing" cards={amazings} {isLoading}>
			<h2 id="⚓-amazing">
		...
		<CardSection anchor="radiant" cards={radiant} {isLoading}>
			<h2 id="⚓-radiant">
		...
		<CardSection anchor="trainer-gallery-holo" cards={basicGallery} {isLoading}>
			...
			<p>
				...
				<mark>large color dodge linear gradient</mark>, and a
				<mark>hard-light radial gradient</mark> on top, at the cursor position, to
				give the shimmer.
			</p>
		</CardSection>

		<CardSection anchor="v" cards={vee} {isLoading}>
			<h2 id="⚓-v">
		...
		<CardSection anchor="v-full-art" cards={veeUltra} {isLoading}>
			<h2 id="⚓-v-full-art">
				<a href="#⚓-v-full-art">
		...
		<CardSection anchor="v-alternate-art" cards={veeAlt} {isLoading}>
		...
		<CardSection anchor="v-max" cards={veeMax} {isLoading}>
			<h2 id="⚓-v-max">
				<a href="#⚓-v-max"> VMax </a>
			</h2>
			<p>
		...
		<CardSection anchor="v-max-alternate" cards={veeMaxAlt} {isLoading}>
			...
			<p>
				There's some VMax cards that show a <mark
					>full, or alternate artwork</mark
				>. These are
		...
		<CardSection anchor="v-star" cards={veeStar} {isLoading}>
			<h2 id="⚓-v-star">
		...
		<CardSection anchor="trainer-full-art" cards={trainerHolo} {isLoading}>
			...
			<p>
				...
				<mark>slightly more subtle and refined effect</mark>, appropriate for
				the character illustrations.
			</p>
		</CardSection>

		<CardSection anchor="rainbow-rare" cards={rainbow} {isLoading}>
			<h2 id="⚓-rainbow-rare">
				<a href="#⚓-rainbow-rare">
		...
		<CardSection anchor="secret-rare" cards={gold} {isLoading}>
			<h2 id="⚓-secret-rare">
				<a href="#⚓-secret-rare">
		...
		<CardSection anchor="trainer-gallery-v" cards={veeGallery} {isLoading}>
		...
		<CardSection anchor="shiny-vault" cards={shinyVault} {isLoading}>
			<h2 id="⚓-shiny-vault">
				<a href="#⚓-shiny-vault">
